...
if !isdefined(@__MODULE__, :CompositePulse)
    ...
    include(joinpath(_SRC, "chimera", "eoms", "state_1st.jl"))
    include(joinpath(_SRC, "chimera", "eoms", "closure_1st.jl"))
    include(joinpath(_SRC, "chimera", "eoms", "closure_1st_ip.jl"))
    include(joinpath(_SRC, "pulse_optimizer2.jl"))
end
if !isdefined(@__MODULE__, :prepare_derived)
    include(joinpath(_SRC, "chimera", "frequency.jl"))
    include(joinpath(_SRC, "chimera", "coupling.jl"))
    include(joinpath(_SRC, "chimera", "ensemble.jl"))
    include(joinpath(_SRC, "chimera", "quadrature.jl"))
end
